            ...
            <div className="flex items-center justify-between">
              ...
              >
                ...
                <SheetContent className="px-0">
                  ...
                  <div className="borber-b overflow-x-auto border-solid py-5">
                    <Calendar
                      mode="single"
                      locale={ptBR}
                  ...
                  {selectedDay && (
                    <div className="flex gap-3 overflow-x-auto border-b border-t border-solid p-5 px-5 [&::-webkit-scrollbar]:hidden">
